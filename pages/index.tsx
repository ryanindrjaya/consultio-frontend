    ...
    <div className="scroll-smooth overflow-hidden">
      ...
      <main>
        ...
        <section id="hero2" className="mt-32 flex flex-col lg:flex-row items-center gap-x-20 mb-52">
          ...
          >
            <h2 className="font-inter font-bold text-4xl lg:text-5xl mt-6 lg:mt-0 mb-6 text-center lg:text-left">
              Our{" "}
              <motion.span
                initial={{ color: "#000" }}
            ...
            <p className="font-normal text-xl leading-loose text-justify px-10 lg:px-0">
        ...
        <section className="hero3">
          ...
          <div className="flex flex-wrap px-4 lg:px-0 lg:flex-nowrap gap-x-9 gap-y-11 mb-11">
            <motion.div
              ...
              className="w-full cursor-pointer lg:w-2/4 hover:bg-primary hover:text-white duration-75 bg-primary/10 rounded-xl shadow-md p-5 flex gap-x-5"
            >
              <div className="bg-white w-2/5 rounded-xl shadow-md px-3 py-2">
            ...
            >
              ...
              <div className="w-3/5">
                ...
                <p className="font-normal text-lg">
                  Kami akan mendengarkan keluh kesahmu dan mencari solusi bersama disini dengan konsultas hukum yang terpercaya
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="mt-40 mb-32">
          <div className="text-center mb-24">
            <h2 className="font-inter font-bold text-5xl">Apa yang mereka katakan</h2>
            <div className="flex justify-center">
              <div className="flex justify-center gap-x-3">
                <h2 className="font-inter font-bold text-5xl">tentang</h2>
                <div className="w-fit relative">
                  <h2 className="font-inter relative z-20 font-bold text-5xl">Consultio</h2>
                  <motion.div
                    initial={{ opacity: 0.2, width: 0 }}
                    whileInView={{ opacity: 0.6, width: "100%" }}
                    transition={{ duration: 1, delay: 0.5 }}
          ...
          <div
            className="px-20 mx-10 lg:mx-0 py-16 flex flex-col-reverse lg:flex-row bg-primary/10 shadow-xl relative transition-all"
