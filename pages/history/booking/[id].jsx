import { ArrowSquareRight, ReceiptText } from "iconsax-react";
      ...
      <div className="mx-4 p-4">
        <div className="flex items-center">
          <div className="flex items-center text-primary relative">
            ...
            <div className="absolute top-0 -ml-14 text-center mt-14 w-44 text-xs font-bold font-poppins text-black">
              Konsultan dan Masalahmu
            </div>
          </div>
